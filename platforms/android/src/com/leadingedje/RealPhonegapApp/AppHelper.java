...
public class AppHelper {
    ...
    private static final String APK_DATABASE_DIR = "www/database";
    // Our database name
    ...
    public AppHelper( Context context ) {
        Log.d( RealPhonegapApp.TAG, "AppHelper constructor called" );
    ...
    public boolean databaseExists() {
        Log.d( RealPhonegapApp.TAG, "AppHelper.databaseExists: Checking for existence of " + DB_NAME + " database files" );
        ...
        Log.d( RealPhonegapApp.TAG, "AppHelper.databaseExists: " + DB_NAME + " database exists? " + dbExists );
        return dbExists;
    }
    ...
    public boolean copyDatabaseFiles() {
        Log.d( RealPhonegapApp.TAG, "AppHelper.copyDatabaseFiles: Copying database files" );
        ...
        try {
            ...
            Log.e( RealPhonegapApp.TAG, "AppHelper.copyDatabaseFiles: Unable to copy database files", exc );
    ...
    private void copyAssetFile( String source, String destination ) throws IOException {
        Log.d( RealPhonegapApp.TAG, "AppHelper.copyAssetFile: Copying " + source + " to " + destination );
        ...
        Log.d( RealPhonegapApp.TAG, "AppHelper.copyAssetFile: Copy successful" );
    }
}
